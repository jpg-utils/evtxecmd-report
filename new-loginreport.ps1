...
#input parameters
#$csvpath- location of an csv output file from evtxecmd
#$reportpath- directory where generated html report should be put 
...
param(
    ...
    [string]$csvpath,  #filepath to your log file
    [parameter(Mandatory=$true)]
    [string]$reportpath #filepath to your end report
)


$logins = Get-Content  $csvpath `
    | ConvertFrom-Csv
...
$output | Out-File $reportpath\login_report.html

#if script is run manually, launch the report at completion
if ([System.Environment]::UserInteractive){
Invoke-Item $reportpath\login_report.html
}
